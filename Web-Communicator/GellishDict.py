class GellishDict(dict):
    ...
    def add_name_in_context(self, name_in_context, value_triple):
        if name_in_context not in self:
            ...
            print('Error: Name in context: {}, {} is already known by uid ({})'.
                  format(name_in_context, value_triple, value_triple2))
    ...
    def filter_on_key(self, q_string, string_commonality):
        """ Search for q-string in the third part of the key of the dictionary,
            ...
            Returns a list of items (key, value_triple) that contain q_string
                    as the third part of the key.
            Example item: term_in_context, value_triple =
        ...
        if string_commonality == string_commonalities[0]:
            ...
            print('Error: string commonality {} unknown'.format(string_commonality))
            filt = ''
