...
reality_col = 5  # text,   39       Name of being a real or an imaginary object
intent_uid_col = 6  # integer,5     UID of an intention with which the expression is communicated
...
phrase_type_uid_col = 19  # integer,85   UID of a phrase type: base = 6066, inverse = 1986.
