...
from tkinter import ttk, Frame, Scrollbar, Button, Canvas, NSEW, E, NS, S, EW, W, \
    VERTICAL, HORIZONTAL
...
from Expr_Table_Def import rel_type_uid_col, rel_type_name_col, \
    lh_name_col, rel_type_name_col, rh_name_col, status_col, \
